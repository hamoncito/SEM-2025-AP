...
Przedstawiono potencjał konwolucyjnych sieci neuronowych w obszarze \textit{computer-aided diagnosis}, jednocześnie zwracajac uwagę na istniejąc ograniczenia, takie jak ramy etyczne i regulacyjne, kwestie poufności oraz bezpieczeństwa danych pacjentów, brak wyjaśnialności decyzji oraz brak niezależnych oraz reprezentatywnych zbiorów danych.
...
Zbadano skuteczność siedmiu architektur konwolucyjnych.
...
Pomimo tych ograniczeń zaprezentowany system wykazuje znaczący potencjał w obszarze diagnostyki cyfrowej.
