...
Przykładowe obrazy tej klasy przedstawiono na rysunku \ref{fig:bcc_sample}.
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth]{ack_sample}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth]{nev_sample}
	\caption{Klasa "`nevus''}
	\source{Opracowanie własne}
...
Przykład raka kolczystokomórkowego pokazano na rysunku \ref{fig:scc_sample}.
	
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth]{scc_sample}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth]{mel_sample}
